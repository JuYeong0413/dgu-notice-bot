...
async def react_test(ctx):
    ...
    await test_channel.send(general_message)
    await test_channel.send(academic_message)
    await test_channel.send(scholarship_message)
    await test_channel.send(cse_message)
